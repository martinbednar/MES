...
{
    internal class AutoScrewDataReadyHandler : NewDataReadyAbstractHandler
    {
        protected override AbstractOpcUaClient opcUaClient { get; } = ScrewOpcUaClient.Instance;
        protected override string RootNodeId { get; } = @"ns=3;s=""dataAutoScrewOPC""";
        ...
        protected internal override async Task SaveRecord()
        {
            ...
            dbContext.AutoScrewingProcessData.Add(new AutoScrewingProcessData()
            {
